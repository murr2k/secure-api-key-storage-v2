...
class KeyRotationManager:
        ...
        try:
            ...
            for event in reversed(self.rotation_history):
                if (
                    ...
                    and event.rolled_back_at is None
                ):
            ...
            for key_info in all_keys:
                ...
                if (
                    metadata.get("type") == "backup"
                    and metadata.get("original_key") == storage_key_name
                ):
    ...
    def schedule_rotation(
        self, profile: str, key_name: str, rotation_date: datetime, reason: str = "scheduled"
    ):
        """
    ...
    def get_rotation_history(
        self, profile: Optional[str] = None, key_name: Optional[str] = None
    ) -> List[Dict]:
        """
    ...
    def generate_rotation_report(self, days: int = 30) -> Dict:
        ...
        report = {
            ...
            "summary": {"total_rotations": 0, "successful": 0, "failed": 0, "rolled_back": 0},
            "by_provider": {},
            "by_reason": {},
            "failures": [],
        }
