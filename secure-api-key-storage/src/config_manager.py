...
from .secure_storage import APIKeyStorage as SecureKeyStorage
...
class ConfigurationManager:
    ...
    def _load_main_config(self) -> Dict:
        ...
        if self.main_config_file.exists():
            ...
            default_config = {
                ...
                "settings": {"auto_rotate": False, "rotation_days": 90, "backup_enabled": True},
            }
    ...
    def export_profile(self, profile_name: str, output_file: str, include_keys: bool = False):
        ...
        export_data = {"profile": profile_data, "exported": datetime.now().isoformat()}
...
def quick_setup(provider: str, api_key: str, profile: str = "default") -> bool:
    ...
    key_config = APIKeyConfig(
        name=f"{provider}_key", provider=ServiceProvider(provider.lower()), environment="production"
    )
