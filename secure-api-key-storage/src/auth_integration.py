...
class AuthIntegration:
    ...
    def cli_login(self, username: Optional[str] = None, use_certificate: bool = False) -> Dict[str, Any]:
    ...
    def create_dashboard_auth_routes(self, auth_module):
        ...
        async def enhanced_login(form_data: OAuth2PasswordRequestForm = Depends(), request: Request = None):
            ...
            try:
                ...
                return {
                    ...
                    "token_type": "bearer",
                    "require_2fa": auth_result.get('require_2fa', False) and auth_result.get('totp_configured', False)
                }
        ...
        async def setup_2fa(user: dict = Depends(get_current_user)) -> Setup2FAResponse:
            ...
            try:
                ...
                return Setup2FAResponse(
                    qr_code=tfa_data['qr_code'],
                    backup_codes=tfa_data['backup_codes']
                )
        ...
        async def setup_certificate(
            request: CertificateSetupRequest,
            user: dict = Depends(get_current_user)
        ):
            ...
            try:
                ...
                return {
                    "message": "Certificate authentication configured",
                    **cert_info
                }
