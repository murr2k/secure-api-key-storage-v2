...
class ClaudeIntegration(BaseIntegration):
    ...
    def create_message(
        ...
        **kwargs,
        ...
        try:
            ...
            response = requests.post(
                f"{self.api_base_url}/messages", headers=headers, json=data, timeout=60
            )
    ...
    def stream_message(
        ...
        **kwargs,
        ...
        try:
            ...
            response = requests.post(
                f"{self.api_base_url}/messages", headers=headers, json=data, stream=True, timeout=60
            )
    ...
    def create_prompt_template(self, name: str, template: str, variables: List[str]) -> None:
        ...
        self._config["prompt_templates"][name] = {"template": template, "variables": variables}
        self.save_config(self._config)
